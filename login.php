            ...
            <form method="POST" action="" class="space-y-md needs-validation" novalidate>
                ...
                <div class="space-y-xs">
                    ...
                    <div class="relative flex items-center">
                        ...
                        <input class="w-full pl-[52px] pr-[52px] py-md bg-surface border border-outline-variant rounded-xl focus:ring-2 focus:ring-primary focus:border-primary transition-all font-body-md text-body-md placeholder:text-outline-variant" id="password" name="password" placeholder="Enter your password" type="password" required/>
                ...
                <div class="flex justify-center pt-md">
                    <a class="font-body-sm text-body-sm text-on-surface-variant hover:text-primary transition-colors" href="register.php">
                        Don't have an account? <span class="text-primary font-bold">Register here</span>
                    </a>
                </div>
            </form>
        </div>
